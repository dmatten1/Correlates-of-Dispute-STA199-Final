...
-   What are your team goals for this project?
    ...
    Our team goal is to successfully collaborate and finish the project.

<!-- -->

-   What do you want to accomplish?
    What skills do you want to develop or refine?

    We want to create a project in R, and learn how to collaborate with other data scientists on the same project.
...
As a team, generally 1:30 pm on Fridays work for all of us.
...
We've decided to meet in-person in Perkins for team meetings.
...
We've decided to just use text messages.
...
Just alert all members through the group chat.
...
Everyone should have their work completed at least by noon the day before the work is due.

-   How should team members communicate if they're struggling with the portion of the work assigned to them?

Text in the group chat to let other members know.

# Policies & procedures

What rules can you agree on to help you meet your goals and expectations?

Be as communicative as possible so that we can be as efficient as possible.

# Consequences

How will you address non-performance in regard to these goals, expectations, policies and procedures?

Discuss in the group chat and check in with team members to see what is going on.
...
Team member name: Allison Yang

Team member name: Ashley Deleon

Team member name: Daniel Matten

Team member name: Jacob Ominsky

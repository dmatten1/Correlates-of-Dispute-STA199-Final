...
As a baseline, we found the correlation coefficients between different military capabilities and the total incident count to focus our analysis on the most relevant variables.
We generated scatterplots for said variables afterwards, however, we could not normalize the data as several countries had 0 total incident counts.
Thus, we could not take the natural log to improve our visualization as this would remove a lot of our data.
...
Our hypothesis tests were based on difference in medians rather than means because of how heavily skewed our data was.

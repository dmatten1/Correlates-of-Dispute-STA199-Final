...
#colored bc countries (too many).    #colors don't seem to work for me
ggplot(country_join_continents, aes(x = irst, y = count, color = stabb)) +
  geom_point() + 
...
ggplot(country_join_continents, aes(x = irst, y = count)) +
  geom_point() + 
   labs(title = "Iron and steel production (thousands of tons) vs Incident Count by Country",
       x = "Iron and steel production (thousands of tons)",
       y = "Count") +
...
Focus can be on the continent with the highest propensity for conflict (?)

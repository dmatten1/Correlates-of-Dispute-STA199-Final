...
The primary motivation for this research is to explore the relationship between national material capabilities and a country’s likelihood of being involved in conflicts. Understanding how changes in a nation’s military capabilities — such as military expenditures and natural resources like iron — affect its involvement in international disputes is important for assessing political stability.

The data used in our analysis comes from the Correlates of War (COW) project, which consists of two datasets that apply to our research- National Material Capabilities and Militarized Interstate Disputes. The former dataset includes annually collected data on military power indicators for each nation, such as military expenditures, military personnel, etc. The latter records instances where states threaten, display, or use force against one another every year from 1816 to 2014. 
...
Explanatory analysis of the response variable count showed a variation in conflict frequency across countries, with some nations consistently engaging in dispute. Patterns in military expenditure and iron and steel production were also examined in order to determine the relationships between material capabilities and conflict frequency. 

We aimed to explore whether it would be worthwhile to investigate a potential relationship, so we visualized periods with heightened levels of both conflict and military capabilities, with a particular focus on iron. Figures 2 and 3 shows an increase in activity around the same periods. 
...
@tbl-cor-table demonstrates that the correlations between incident count and military expenditures, military personnel, and iron and steel production, are 0.21, 0.106, and 0.163 respectively. While all relatively low, this finding caused us to narrow our focus onto military expenditures and iron and steel production, as those had the highest linear correlation with total incident count. 
...
To identify the relationship between conflict frequency and military capabilities we decided to do a series of visualizations using histograms. Focusing on the Military Expenditures and Iron production as they had the highest correlation within the set.

...
As a baseline, we found the correlation coefficients between different military capabilities and the total incident count to focus our analysis on the most relevant variables (being military expenditure and iron and steel production).

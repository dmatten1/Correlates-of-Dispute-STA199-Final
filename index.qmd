...
bootstrap_medians_avg_irst <- tibble(
  `(avg high irst) incident count median` = mean(as.numeric(bootstrap_medians_df$high), na.rm = TRUE),
  `(avg low irst) incident count median` = mean(as.numeric(bootstrap_medians_df$low), na.rm = TRUE),
  )

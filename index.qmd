...
*Figure 2 & Figure 4*: Both scatter plots reveal that there is an extremely weak positive linear relationship between military expenditure (milex) or iron and steel production (irst) and total incident number.
